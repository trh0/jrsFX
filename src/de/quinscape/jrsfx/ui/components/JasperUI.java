...
import de.quinscape.jrsfx.jasper.RepositoryResource;
...
public class JasperUI {
	...
	public static TreeItem<String> repositoryTreeItem(List<RepositoryResource> resources) {
		...
		resources.forEach(r -> {
			...
			if (!r.getResourceType().equals(RepositoryResource.FOLDER)) {
